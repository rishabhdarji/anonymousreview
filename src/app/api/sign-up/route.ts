...
export async function POST(request: Request){
    ...
    try {
       ...
       if (existingUserVerifiedByUsername) {
        ...
        } else if (existingUserVerifiedByEmail && !existingUserVerifiedByEmail.isVerified) {
        ...
        console.error("Error connecting to the database, failed to register user:", error);
        return Response.json({
            success: false,
